...
blockl1Var = instance_create_layer(176, 16, "Instances", blockl1);
...
blocklR1Var = instance_create_layer(176, 16, "Instances", blocklR1); 
blocklR2Var = instance_create_layer(144, 16, "Instances", blocklR2);

...
for(var i = blocklR4Var.y; i > 0; i -= 32)
        {
            ...
            if (pos1 != noone || pos2 != noone || pos3 != noone || pos4 != noone)
            {
                ...
                else if(pos1 != noone && pos1.y > blockl4Var.y){diff = blocklR4Var.y - pos1.y;}
                else if(pos2 != noone && pos2.y > blockl4Var.y){diff = blocklR4Var.y - pos2.y; diff -= defaulted ? 32 : 0;}
                blocklR4Var.y -= diff;
                blocklR3Var.y -= diff;
                blocklR2Var.y -= diff;
                blocklR1Var.y -= diff;
...
else if(keyboard_check_released(vk_down) && !global.isPaused)
{
    alarm[1] = -1;
    alarm[0] = 10;	
    reles = true;
